...
// По задаче 8 ошибка в алгоритме, не выводится последнее число, если N чётное.
// Строки 34, 36 и 38 можно объединить по условию:
// if (num1 == 0 || num1 == 1 || num1 == 2 ) {}
// Или задать диапазон - if (num1 > -2 && num1 < 2).
// Также в решении избыточный вывод - "Чётное число" не нужно.